...
L:RegisterTranslations("zhCN", function() return {
	["Notes"] = "标记",
	["Module which allows you to put notes on the map."] = "允许你在地图上记标记的模块.",
	...
	["Send to raid"] = "发送到团队",
	["Send to guild"] = "发送到公会",
	["Send to player"] = "发送到玩家",
	
	["Note: This may be blocked by Blizzard's spam filter and cause problems. It is recommended to send to your party/raid/guild instead."] = "注意：这可能被暴雪的垃圾邮件过滤器阻塞并导致问题. 建议发送到 队伍/公会/团队.",
	...
	["Ctrl-Right-Click on map to add a note"] = "Ctrl+右键-点击地图新增标记",
	
	["%s from Guild"] = "%s 从公会",
	["%s from Raid"] = "%s 从团队",
	["%s from Party"] = "%s 从队伍",
	
	["Error: %s sent you a note with an unknown zone: %q"] = "错误: %s 寄给你一张未知区域的便条： %q",
	["Error: %s sent you a note at %q : %.1f, %.1f with the title %q created by %q, but you already have a note at this location."] = "错误: %s 寄给你一张在 %q : %.1f, %.1f 与标题 %q (由 %q 创建), 然而，你已经有了这个地方的标记.",
	["%s sent you a note at %q : %.1f, %.1f with the title %q created by %q."] = "%s 寄给你一张便条 %q : %.2f, %.2f 标题 %q (创建者 %q).",

	["Created by"] = "创建者 ",
	
	["Show note creator"] = "显示创建者",
	["Show the `Created By:' line in notes"] = "在注释中显示“创建者”创建的行",
