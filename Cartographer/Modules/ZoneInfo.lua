...
L:RegisterTranslations("zhCN", function() return {
	["Zone Info"] = "区域信息",
	["Module which on hovering over a zone, will show the levels of the zone, the instances in the zone, their levels, and the number of men the instance is made for (e.g. 5-man, 40-man)."] = "悬停在一个区域上,将显示区域的级别,区域中的副本.和副本人数（如5人，40人）",
