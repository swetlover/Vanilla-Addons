...
L:RegisterTranslations("zhCN", function() return {
	["Group Colors"] = "队伍颜色.团队组数",
	["Module which turns all your party's and your raid's POIs into circles colored based on class, and shows a number on them based on their raid group."] = "模块变化你的队伍和你的团队的标记点为职业颜色.RAID组数",
} end)
