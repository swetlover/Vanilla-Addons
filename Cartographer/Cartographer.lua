...
BINDING_HEADER_CARTOGRAPHER = "Cartographer地图套件"
BINDING_NAME_CARTOGRAPHER_OPENALTERNATEMAP = "打开备用的地图"
...
L:RegisterTranslations("zhCN", function() return {
	...
	["Right-Click on map to zoom out"] = "右键单击地图以缩小",
	["Left-Click on map to zoom in"] = "左键单击地图以放大",
