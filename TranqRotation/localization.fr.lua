...
TQ_MSG_FEAR       = " effray%a+";
TQ_MSG_PANIC      = "Panique";
TQ_MSG_TIMELAPSE  = "Trou de temps";
TQ_MSG_TIMESTOP   = "Arrêt du temps";
TQ_MSG_WSTING     = "Piqûre de wyverne";
TQ_MSG_MINDFLAY   = "Fouet mental";
TQ_MSG_CAUSEINS   = "Rendre fou";
