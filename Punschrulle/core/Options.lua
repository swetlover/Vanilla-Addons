...
function Punsch_Options_MainWindow_Create()
	...
	PunschOptionWindow.Title:SetText("Punschrulle施法条 By 60addons 汉化 v" .. PunschrulleVersion)
...
function Punsch_Options_EditCastbarText_Create() 
	...
	PunschEditFrames["CastbarText"].Handle,PunschEditFrames["CastbarText"].ChildHandle = Punsch_Options_EditFrame_Create("施法条文本") 
...
function Punsch_Options_EditMirrorText_Create() 
	...
	PunschEditFrames["MirrorText"].Handle,PunschEditFrames["MirrorText"].ChildHandle = Punsch_Options_EditFrame_Create("镜像文本") 
...
function Punsch_Options_EditMirrorEvents_Create() 
	...
	PunschEditFrames["MirrorEvents"].Handle,PunschEditFrames["MirrorEvents"].ChildHandle = Punsch_Options_EditFrame_Create("镜像事件") 
	...
	for name,_ in pairs(PunschrulleDB.Profiles[PunschrulleProfile]["Entities"]["Mirror"]["Events"]) do
		...
		e.o[e.num], PunschEditFrames["MirrorEvents"][name] = Punsch_Options_EditFrame_CreateEditTextOption(e,"图标", function () 
...
function Punsch_Options_About_Create() 
	...
	local txt = cfs("Punschrulle 施法条 v" .. PunschrulleVersion,30)
	txt:SetPoint("TOPLEFT", e, "TOPLEFT",0,t)
	txt:SetPoint("RIGHT", e)

	t = t -23
	local txt = cfs("By 60addons 汉化",20)
	txt:SetPoint("TOPLEFT", e, "TOPLEFT",0,t)
	txt:SetPoint("RIGHT", e)
	...
	editbox:SetText("http://www.60addons.com/")
	editbox:SetAutoFocus(false)
