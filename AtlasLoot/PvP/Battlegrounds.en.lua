...
AtlasLoot_Data["AtlasLootGeneralPvPItems"] = {
	PVPWeapons1 = {
		{ 0, "INV_BannerPVP_02", "=q8=#m7#", "=q7=R 14" },
		{ 0, "", "", "" },
		...
		{ 0, "INV_BannerPVP_01", "=q6=#m6#", "=q18=R 14" },
		{ 0, "", "", "" },
	...
	PvP60Accessories1 = {
		{ 0, "", "", "" },
		{ 0, "INV_BannerPVP_02", "=q8=#m7#", "=q7=R 2" },
		{ 0,"","","" },
		...
		{ 0,"","","" },
		{ 0,"","","" },
		{ 0, "INV_BannerPVP_01", "=q6=#m6#", "=q18=R 2" },
		{ 0,"","","" },
	...
	PvP60Accessories2 = {
		{ 18442, "INV_Misc_MonsterScales_09", "=q3=Master Sergeant's Insignia", "=ds=#s2# =q7=R 4" },
		{ 18444, "INV_Misc_MonsterScales_09", "=q3=Master Sergeant's Insignia", "=ds=#s2# =q7=R 4" },
		{ 18443, "INV_Misc_MonsterScales_09", "=q3=Master Sergeant's Insignia", "=ds=#s2# =q7=R 4" },
		{ 0,"","","" },
		{ 18440, "INV_Misc_Cape_21", "=q3=Sergeant's Cape", "=ds=#s4# =q7=R 3" },
		{ 18441, "INV_Misc_Cape_21", "=q3=Sergeant's Cape", "=ds=#s4# =q7=R 3" },
		{ 16342, "INV_Misc_Cape_21", "=q3=Sergeant's Cape", "=ds=#s4# =q7=R 3" },
		{ 0,"","","" },
		{ 15196, "INV_Misc_TabardPVP_01", "=q1=Private's Tabard", "=ds=#s7# =q7=R 1" },
		{ 15198, "INV_Misc_TabardPVP_03", "=q1=Knight's Colors", "=ds=#s7# =q7=R 6" },
		{ 0,"","","" },
		{ 18606, "INV_BannerPVP_02", "=q1=Alliance Battle Standard", "=ds=#m8# =q7=R 9" },
		{ 0,"","","" },
		{ 18839, "INV_Potion_39", "=q1=Combat Healing Potion", "=ds=#e2#" },
		{ 18841, "INV_Potion_81", "=q1=Combat Mana Potion", "=ds=#e2#" },
		{ 18457, "INV_Bracer_07", "=q3=Sergeant Major's Silk Cuffs", "=ds=#s8#, #a1# =q9=#c5#=ds=, =q10=#c3#=ds=, =q11=#c8# =q7=R 5" },
		{ 18456, "INV_Bracer_07", "=q3=Sergeant Major's Silk Cuffs", "=ds=#s8#, #a1# =q9=#c5#=ds=, =q10=#c3#=ds=, =q11=#c8# =q7=R 5" },
		{ 0,"","","" },
		{ 18455, "INV_Bracer_03", "=q3=Sergeant Major's Dragonhide Armsplints", "=ds=#s8#, #a2# =q13=#c1# =q7=R 5" },
		{ 18454, "INV_Bracer_03", "=q3=Sergeant Major's Dragonhide Armsplints", "=ds=#s8#, #a2# =q13=#c1# =q7=R 5" },
		{ 0,"","","" },
		{ 18453, "INV_Bracer_07", "=q3=Sergeant Major's Leather Armsplints", "=ds=#s8#, #a2# =q12=#c6# =q7=R 5" },
		{ 18452, "INV_Bracer_07", "=q3=Sergeant Major's Leather Armsplints", "=ds=#s8#, #a2# =q12=#c6# =q7=R 5" },
		{ 0,"","","" },
		{ 18449, "INV_Bracer_06", "=q3=Sergeant Major's Chain Armguards", "=ds=#s8#, #a3# =q14=#c2# =q7=R 5" },
		{ 18448, "INV_Bracer_06", "=q3=Sergeant Major's Chain Armguards", "=ds=#s8#, #a3# =q14=#c2# =q7=R 5" },
		{ 0,"","","" },
		{ 18447, "INV_Bracer_18", "=q3=Sergeant Major's Plate Wristguards", "=ds=#s8#, #a4# =q17=#c9#=ds=,  =q16=#c4# =q7=R 5" },
		{ 18445, "INV_Bracer_18", "=q3=Sergeant Major's Plate Wristguards", "=ds=#s8#, #a4# =q17=#c9#=ds=,  =q16=#c4# =q7=R 5" },
	};
	PvP60Accessories3 = {
		{ 15200, "INV_Misc_MonsterScales_15", "=q3=Senior Sergeant's Insignia", "=ds=#s2# =q18=R 4" },
		{ 18428, "INV_Misc_MonsterScales_15", "=q3=Senior Sergeant's Insignia", "=ds=#s2# =q18=R 4" },
		{ 16335, "INV_Misc_MonsterScales_15", "=q3=Senior Sergeant's Insignia", "=ds=#s2# =q18=R 4" },
		{ 0,"","","" },
		{ 18427, "INV_Misc_Cape_07", "=q3=Sergeant's Cloak", "=ds=#s4# =q18=R 3" },
		{ 16341, "INV_Misc_Cape_07", "=q3=Sergeant's Cloak", "=ds=#s4# =q18=R 3" },
		{ 18461, "INV_Misc_Cape_07", "=q3=Sergeant's Cloak", "=ds=#s4# =q18=R 3" },
		{ 0,"","","" },
		{ 15197, "INV_Misc_TabardPVP_02", "=q1=Scout's Tabard", "=ds=#s7# =q18=R 1" },
		{ 15199, "INV_Misc_TabardPVP_04", "=q1=Stone Guard's Herald", "=ds=#s7# =q18=R 6" },
		{ 0,"","","" },
		{ 18607, "INV_BannerPVP_01", "=q1=Horde Battle Standard", "=ds=#m8# =q18=R 9" },
		{ 0,"","","" },
		{ 18839, "INV_Potion_39", "=q1=Combat Healing Potion", "=ds=#e2#" },
		{ 18841, "INV_Potion_81", "=q1=Combat Mana Potion", "=ds=#e2#" },
		{ 18437, "INV_Bracer_07", "=q3=First Sergeant's Silk Cuffs", "=ds=#s8#, #a1# =q9=#c5#=ds=, =q10=#c3#=ds=, =q11=#c8# =q18=R 5" },
		{ 16486, "INV_Bracer_07", "=q3=First Sergeant's Silk Cuffs", "=ds=#s8#, #a1# =q9=#c5#=ds=, =q10=#c3#=ds=, =q11=#c8# =q18=R 5" },
		{ 0,"","","" },
		{ 18436, "INV_Bracer_03", "=q3=First Sergeant's Dragonhide Armguards", "=ds=#s8#, #a2# =q13=#c1# =q18=R 5" },
		{ 18434, "INV_Bracer_03", "=q3=First Sergeant's Dragonhide Armguards", "=ds=#s8#, #a2# =q13=#c1# =q18=R 5" },
		{ 0,"","","" },
		{ 18435, "INV_Bracer_07", "=q3=First Sergeant's Leather Armguards", "=ds=#s8#, #a2# =q12=#c6# =q18=R 5" },
		{ 16497, "INV_Bracer_07", "=q3=First Sergeant's Leather Armguards", "=ds=#s8#, #a2# =q12=#c6# =q18=R 5" },
		{ 0,"","","" },
		{ 18432, "INV_Bracer_16", "=q3=First Sergeant's Mail Wristguards", "=ds=#s8#, #a3# =q14=#c2#=ds=, =q15=#c7# =q18=R 5" },
		{ 16532, "INV_Bracer_16", "=q3=First Sergeant's Mail Wristguards", "=ds=#s8#, #a3# =q14=#c2#=ds=, =q15=#c7# =q18=R 5" },
		{ 0,"","","" },
		{ 18430, "INV_Bracer_19", "=q3=First Sergeant's Plate Bracers", "=ds=#s8#, #a4# =q17=#c9# =q18=R 5" },
		{ 18429, "INV_Bracer_19", "=q3=First Sergeant's Plate Bracers", "=ds=#s8#, #a4# =q17=#c9# =q18=R 5" },
	};
	PVPHunter = {
		{ 0, "INV_BannerPVP_02", "=q8=#pvpea2#", "=q7=#pvps1#" },
		{ 16465, "INV_Helmet_05", "=q4=Field Marshal's Chain Helm", "=ds=#s1#, #a3# =q7=R 13" },
		{ 16468, "INV_Shoulder_10", "=q4=Field Marshal's Chain Spaulders", "=ds=#s3#, #a3# =q7=R 13" },
		{ 16466, "INV_Chest_Chain_03", "=q4=Field Marshal's Chain Breastplate", "=ds=#s5#, #a3# =q7=R 13" },
		{ 16463, "INV_Gauntlets_10", "=q4=Marshal's Chain Grips", "=ds=#s9#, #a3# =q7=R 12" },
		{ 16467, "INV_Pants_Mail_17", "=q4=Marshal's Chain Legguards", "=ds=#s11#, #a3# =q7=R 12" },
		{ 16462, "INV_Boots_Plate_07", "=q4=Marshal's Chain Boots", "=ds=#s12#, #a3# =q7=R 12" },
		{ 0, "", "", "" },
		{ 0, "INV_BannerPVP_02", "=q8=#pvpra2#", "=q7=#pvps2#" },
		{ 23306, "INV_Helmet_21", "=q3=Lieutenant Commander's Chain Helm", "=ds=#s1#, #a3# =q7=R 10" },
		{ 23307, "INV_Shoulder_16", "=q3=Lieutenant Commander's Chain Shoulders", "=ds=#s3#, #a3# =q7=R 10" },
		{ 23292, "INV_Chest_Chain_04", "=q3=Knight-Captain's Chain Hauberk", "=ds=#s5#, #a3# =q7=R 8" },
		{ 23279, "INV_Gauntlets_17", "=q3=Knight-Lieutenant's Chain Vices", "=ds=#s9#, #a3# =q7=R 7" },
		{ 23293, "INV_Pants_03", "=q3=Knight-Captain's Chain Legguards", "=ds=#s11#, #a3# =q7=R 8" },
		{ 23278, "INV_Boots_05", "=q3=Knight-Lieutenant's Chain Greaves", "=ds=#s12#, #a3# =q7=R 7" },
		{ 0, "INV_BannerPVP_01", "=q6=#pvpeh2#", "=q5=#pvps1#" },
		{ 16566, "INV_Helmet_09", "=q4=Warlord's Chain Helmet", "=ds=#s1#, #a3# =q18=R 13" },
		{ 16568, "INV_Shoulder_29", "=q4=Warlord's Chain Shoulders", "=ds=#s3#, #a3# =q18=R 13" },
		{ 16565, "INV_Chest_Chain_11", "=q4=Warlord's Chain Chestpiece", "=ds=#s5#, #a3# =q18=R 13" },
		{ 16571, "INV_Gauntlets_11", "=q4=General's Chain Gloves", "=ds=#s9#, #a3# =q18=R 12" },
		{ 16567, "INV_Pants_Mail_16", "=q4=General's Chain Legguards", "=ds=#s11#, #a3# =q18=R 12" },
		{ 16569, "INV_Boots_Plate_06", "=q4=General's Chain Boots", "=ds=#s12#, #a3# =q18=R 12" },
		{ 0, "", "", "" },
		{ 0, "INV_BannerPVP_01", "=q6=#pvprh2#", "=q5=#pvps2#" },
		{ 23251, "INV_Helmet_03", "=q3=Champion's Chain Helm", "=ds=#s1#, #a3# =q18=R 10" },
		{ 23252, "INV_Shoulder_01", "=q3=Champion's Chain Shoulders", "=ds=#s3#, #a3# =q18=R 10" },
		{ 22874, "INV_Chest_Chain_04", "=q3=Legionnaire's Chain Hauberk", "=ds=#s5#, #a3# =q18=R 8" },
		{ 22862, "INV_Gauntlets_17", "=q3=Blood Guard's Chain Vices", "=ds=#s9#, #a3# =q18=R 7" },
		{ 22875, "INV_Pants_03", "=q3=Legionnaire's Chain Legguards", "=ds=#s11#, #a3# =q18=R 8" },
		{ 22843, "INV_Boots_05", "=q3=Blood Guard's Chain Greaves", "=ds=#s12#, #a3# =q18=R 7" },
	};
	PVPMage = {
		{ 0, "INV_BannerPVP_02", "=q8=#pvpea3#", "=q7=#pvps1#" },
		{ 16441, "INV_Helmet_24", "=q4=Field Marshal's Coronet", "=ds=#s1#, #a1# =q7=R 13" },
		{ 16444, "INV_Shoulder_23", "=q4=Field Marshal's Silk Spaulders", "=ds=#s3#, #a1# =q7=R 13" },
		{ 16443, "INV_Chest_Cloth_12", "=q4=Field Marshal's Silk Vestments", "=ds=#s5#, #a1# =q7=R 13" },
		{ 16440, "INV_Gauntlets_14", "=q4=Marshal's Silk Gloves", "=ds=#s9#, #a1# =q7=R 12" },
		{ 16442, "INV_Pants_08", "=q4=Marshal's Silk Leggings", "=ds=#s11#, #a1# =q7=R 12" },
		{ 16437, "INV_Boots_Cloth_03", "=q4=Marshal's Silk Footwraps", "=ds=#s12#, #a1# =q7=R 12" },
		{ 0, "", "", "" },
		{ 0, "INV_BannerPVP_02", "=q8=#pvpra3#", "=q7=#pvps2#" },
		{ 23318, "INV_Helmet_06", "=q3=Lieutenant Commander's Silk Cowl", "=ds=#s1#, #a1# =q7=R 10" },
		{ 23319, "INV_Shoulder_02", "=q3=Lieutenant Commander's Silk Mantle", "=ds=#s3#, #a1# =q7=R 10" },
		{ 23305, "INV_Chest_Cloth_28", "=q3=Knight-Captain's Silk Tunic", "=ds=#s9#, #a1# =q7=R 8" },
		{ 23290, "INV_Gauntlets_06", "=q3=Knight-Lieutenant's Silk Handwraps", "=ds=#s9#, #a1# =q7=R 7" },
		{ 23304, "INV_Pants_11", "=q3=Knight-Captain's Silk Legguards", "=ds=#s11#, #a1# =q7=R 8" },
		{ 23291, "INV_Boots_05", "=q3=Knight-Lieutenant's Silk Walkers", "=ds=#s12#, #a1# =q7=R 7" },
		{ 0, "INV_BannerPVP_01", "=q6=#pvpeh3#", "=q5=#pvps1#" },
		{ 16533, "INV_Helmet_08", "=q4=Warlord's Silk Cowl", "=ds=#s1#, #a1# =q18=R 13" },
		{ 16536, "INV_Shoulder_19", "=q4=Warlord's Silk Amice", "=ds=#s3#, #a1# =q18=R 13" },
		{ 16535, "INV_Chest_Leather_01", "=q4=Warlord's Silk Raiment", "=ds=#s5#, #a1# =q18=R 13" },
		{ 16540, "INV_Gauntlets_19", "=q4=General's Silk Handguards", "=ds=#s9#, #a1# =q18=R 12" },
		{ 16534, "INV_Pants_07", "=q4=General's Silk Trousers", "=ds=#s11#, #a1# =q18=R 12" },
		{ 16539, "INV_Boots_05", "=q4=General's Silk Boots", "=ds=#s12#, #a1# =q18=R 12" },
		{ 0, "", "", "" },
		{ 0, "INV_BannerPVP_01", "=q6=#pvprh3#", "=q5=#pvps2#" },
		{ 23263, "INV_Helmet_06", "=q3=Champion's Silk Cowl", "=ds=#s1#, #a1# =q18=R 10" },
		{ 23264, "INV_Shoulder_02", "=q3=Champion's Silk Mantle", "=ds=#s3#, #a1# =q18=R 10" },
		{ 22886, "INV_Chest_Cloth_28", "=q3=Legionnaire's Silk Tunic", "=ds=#s9#, #a1# =q18=R 8" },
		{ 22870, "INV_Gauntlets_06", "=q3=Blood Guard's Silk Handwraps", "=ds=#s9#, #a1# =q18=R 7" },
		{ 22883, "INV_Pants_11", "=q3=Legionnaire's Silk Legguards", "=ds=#s11#, #a1# =q18=R 8" },
		{ 22860, "INV_Boots_05", "=q3=Blood Guard's Silk Walkers", "=ds=#s12#, #a1# =q18=R 7" },
	};
	PVPPriest = {
		{ 0, "INV_BannerPVP_02", "=q8=#pvpea5#", "=q7=#pvps1#" },
		{ 17602, "INV_Helmet_24", "=q4=Field Marshal's Headdress", "=ds=#s1#, #a1# =q7=R 13" },
		{ 17604, "INV_Shoulder_02", "=q4=Field Marshal's Satin Mantle", "=ds=#s3#, #a1# =q7=R 13" },
		{ 17605, "INV_Chest_Cloth_02", "=q4=Field Marshal's Satin Vestments", "=ds=#s5#, #a1# =q7=R 13" },
		{ 17608, "INV_Gauntlets_14", "=q4=Marshal's Satin Gloves", "=ds=#s9#, #a1# =q7=R 12" },
		{ 17603, "INV_Pants_06", "=q4=Marshal's Satin Pants", "=ds=#s11#, #a1# =q7=R 12" },
		{ 17607, "INV_Boots_07", "=q4=Marshal's Satin Sandals", "=ds=#s12#, #a1# =q7=R 12" },
		{ 0, "", "", "" },
		{ 0, "INV_BannerPVP_02", "=q8=#pvpra5#", "=q7=#pvps2#" },
		{ 23316, "INV_Helmet_17", "=q3=Lieutenant Commander's Satin Hood", "=ds=#s1#, #a1# =q7=R 10" },
		{ 23317, "INV_Shoulder_01", "=q3=Lieutenant Commander's Satin Mantle", "=ds=#s3#, #a1# =q7=R 10" },
		{ 23303, "INV_Chest_Leather_01", "=q3=Knight-Captain's Satin Tunic", "=ds=#s5#, #a1# =q7=R 8" },
		{ 23288, "INV_Gauntlets_17", "=q3=Knight-Lieutenant's Satin Handwraps", "=ds=#s9#, #a1# =q7=R 7" },
		{ 23302, "INV_Pants_11", "=q3=Knight-Captain's Satin Legguards", "=ds=#s11#, #a1# =q7=R 8" },
		{ 23289, "INV_Boots_05", "=q3=Knight-Lieutenant's Satin Walkers", "=ds=#s12#, #a1# =q7=R 7" },
		{ 0, "INV_BannerPVP_01", "=q6=#pvpeh4#", "=q5=#pvps1#" },
		{ 17623, "INV_Helmet_08", "=q4=Warlord's Satin Cowl", "=ds=#s1#, #a1# =q18=R 13" },
		{ 17622, "INV_Shoulder_19", "=q4=Warlord's Satin Mantle", "=ds=#s3#, #a1# =q18=R 13" },
		{ 17624, "INV_Chest_Leather_01", "=q4=Warlord's Satin Robes", "=ds=#s5#, #a1# =q18=R 13" },
		{ 17620, "INV_Gauntlets_27", "=q4=General's Satin Gloves", "=ds=#s9#, #a1# =q18=R 12" },
		{ 17625, "INV_Pants_07", "=q4=General's Satin Leggings", "=ds=#s11#, #a1# =q18=R 12" },
		{ 17618, "INV_Boots_05", "=q4=General's Satin Boots", "=ds=#s12#, #a1# =q18=R 12" },
		{ 0, "", "", "" },
		{ 0, "INV_BannerPVP_01", "=q6=#pvprh4#", "=q5=#pvps2#" },
		{ 23261, "INV_Helmet_17", "=q3=Champion's Satin Hood", "=ds=#s1#, #a1# =q18=R 10" },
		{ 23262, "INV_Shoulder_01", "=q3=Champion's Satin Mantle", "=ds=#s3#, #a1# =q18=R 10" },
		{ 22885, "INV_Chest_Leather_01", "=q3=Legionnaire's Satin Tunic", "=ds=#s5#, #a1# =q18=R 8" },
		{ 22869, "INV_Gauntlets_17", "=q3=Blood Guard's Satin Handwraps", "=ds=#s9#, #a1# =q18=R 7" },
		{ 22882, "INV_Pants_11", "=q3=Legionnaire's Satin Legguards", "=ds=#s11#, #a1# =q18=R 8" },
		{ 22859, "INV_Boots_05", "=q3=Blood Guard's Satin Walkers", "=ds=#s12#, #a1# =q18=R 7" },
	};
	PVPWarlock = {
		{ 0, "INV_BannerPVP_02", "=q8=#pvpea7#", "=q7=#pvps1#" },
		{ 17578, "INV_Helmet_24", "=q4=Field Marshal's Coronal", "=ds=#s1#, #a1# =q7=R 13" },
		{ 17580, "INV_Shoulder_02", "=q4=Field Marshal's Dreadweave Shoulders", "=ds=#s3#, #a1# =q7=R 13" },
		{ 17581, "INV_Chest_Cloth_09", "=q4=Field Marshal's Dreadweave Robe", "=ds=#s5#, #a1# =q7=R 13" },
		{ 17584, "INV_Gauntlets_14", "=q4=Marshal's Dreadweave Gloves", "=ds=#s9#, #a1# =q7=R 12" },
		{ 17579, "INV_Pants_Cloth_09", "=q4=Marshal's Dreadweave Leggings", "=ds=#s11#, #a1# =q7=R 12" },
		{ 17583, "INV_Boots_07", "=q4=Marshal's Dreadweave Boots", "=ds=#s12#, #a1# =q7=R 12" },
		{ 0, "", "", "" },
		{ 0, "INV_BannerPVP_02", "=q8=#pvpra7#", "=q7=#pvps2#" },
		{ 23310, "INV_Helmet_08", "=q3=Lieutenant Commander's Dreadweave Cowl", "=ds=#s1#, #a1# =q7=R 10" },
		{ 23311, "INV_Shoulder_01", "=q3=Lieutenant Commander's Dreadweave Spaulders", "=ds=#s3#, #a1# =q7=R 10" },
		{ 23297, "INV_Chest_Leather_01", "=q3=Knight-Captain's Dreadweave Tunic", "=ds=#s5#, #a1# =q7=R 8" },
		{ 23282, "INV_Gauntlets_19", "=q3=Knight-Lieutenant's Dreadweave Handwraps", "=ds=#s9#, #a1# =q7=R 7" },
		{ 23296, "INV_Pants_06", "=q3=Knight-Captain's Dreadweave Legguards", "=ds=#s11#, #a1# =q7=R 8" },
		{ 23283, "INV_Boots_05", "=q3=Knight-Lieutenant's Dreadweave Walkers", "=ds=#s12#, #a1# =q7=R 7" },
		{ 0, "INV_BannerPVP_01", "=q6=#pvpeh7#", "=q5=#pvps1#" },
		{ 17591, "INV_Helmet_08", "=q4=Warlord's Dreadweave Hood", "=ds=#s1#, #a1# =q18=R 13" },
		{ 17590, "INV_Shoulder_19", "=q4=Warlord's Dreadweave Mantle", "=ds=#s3#, #a1# =q18=R 13" },
		{ 17592, "INV_Chest_Leather_01", "=q4=Warlord's Dreadweave Robe", "=ds=#s5#, #a1# =q18=R 13" },
		{ 17588, "INV_Gauntlets_19", "=q4=General's Dreadweave Gloves", "=ds=#s9#, #a1# =q18=R 12" },
		{ 17593, "INV_Pants_07", "=q4=General's Dreadweave Pants", "=ds=#s11#, #a1# =q18=R 12" },
		{ 17586, "INV_Boots_05", "=q4=General's Dreadweave Boots", "=ds=#s12#, #a1# =q18=R 12" },
		{ 0, "", "", "" },
		{ 0, "INV_BannerPVP_01", "=q6=#pvprh7#", "=q5=#pvps2#" },
		{ 23255, "INV_Helmet_08", "=q3=Champion's Dreadweave Cowl", "=ds=#s1#, #a1# =q18=R 10" },
		{ 23256, "INV_Shoulder_01", "=q3=Champion's Dreadweave Spaulders", "=ds=#s3#, #a1# =q18=R 10" },
		{ 22884, "INV_Chest_Leather_01", "=q3=Legionnaire's Dreadweave Tunic", "=ds=#s5#, #a1# =q18=R 8" },
		{ 22865, "INV_Gauntlets_19", "=q3=Blood Guard's Dreadweave Handwraps", "=ds=#s9#, #a1# =q18=R 7" },
		{ 22881, "INV_Pants_06", "=q3=Legionnaire's Dreadweave Legguards", "=ds=#s11#, #a1# =q18=R 8" },
		{ 22855, "INV_Boots_05", "=q3=Blood Guard's Dreadweave Walkers", "=ds=#s12#, #a1# =q18=R 7" },
	};
	PVPRogue = {
		{ 0, "INV_BannerPVP_02", "=q8=#pvpea6#", "=q7=#pvps1#" },
		{ 16455, "INV_Helmet_41", "=q4=Field Marshal's Leather Mask", "=ds=#s1#, #a2# =q7=R 13" },
		{ 16457, "INV_Shoulder_23", "=q4=Field Marshal's Leather Epaulets", "=ds=#s3#, #a2# =q7=R 13" },
		{ 16453, "INV_Chest_Cloth_07", "=q4=Field Marshal's Leather Chestpiece", "=ds=#s5#, #a2# =q7=R 13" },
		{ 16454, "INV_Gauntlets_21", "=q4=Marshal's Leather Handgrips", "=ds=#s9#, #a2# =q7=R 12" },
		{ 16456, "INV_Pants_06", "=q4=Marshal's Leather Leggings", "=ds=#s11#, #a2# =q7=R 12" },
		{ 16446, "INV_Boots_08", "=q4=Marshal's Leather Footguards", "=ds=#s12#, #a2# =q7=R 12" },
		{ 0, "", "", "" },
		{ 0, "INV_BannerPVP_02", "=q8=#pvpra6#", "=q7=#pvps2#" },
		{ 23312, "INV_Helmet_09", "=q3=Lieutenant Commander's Leather Helm", "=ds=#s1#, #a2# =q7=R 10" },
		{ 23313, "INV_Shoulder_14", "=q3=Lieutenant Commander's Leather Shoulders", "=ds=#s3#, #a2# =q7=R 10" },
		{ 23298, "INV_Chest_Leather_05", "=q3=Knight-Captain's Leather Chestpiece", "=ds=#s5#, #a2# =q7=R 8" },
		{ 23284, "INV_Gauntlets_15", "=q3=Knight-Lieutenant's Leather Grips", "=ds=#s9#, #a2# =q7=R 7" },
		{ 23299, "INV_Pants_08", "=q3=Knight-Captain's Leather Legguards", "=ds=#s11#, #a2# =q7=R 8" },
		{ 23285, "INV_Boots_05", "=q3=Knight-Lieutenant's Leather Walkers", "=ds=#s12#, #a2# =q7=R 7" },
		{ 0, "INV_BannerPVP_01", "=q6=#pvpeh5#", "=q5=#pvps1#" },
		{ 16561, "INV_Helmet_09", "=q4=Warlord's Leather Helm", "=ds=#s1#, #a2# =q18=R 13" },
		{ 16562, "INV_Shoulder_07", "=q4=Warlord's Leather Spaulders", "=ds=#s3#, #a2# =q18=R 13" },
		{ 16563, "INV_Chest_Chain_16", "=q4=Warlord's Leather Breastplate", "=ds=#s5#, #a2# =q18=R 13" },
		{ 16560, "INV_Gauntlets_25", "=q4=General's Leather Mitts", "=ds=#s9#, #a2# =q18=R 12" },
		{ 16564, "INV_Pants_06", "=q4=General's Leather Legguards", "=ds=#s11#, #a2# =q18=R 12" },
		{ 16558, "INV_Boots_08", "=q4=General's Leather Treads", "=ds=#s12#, #a2# =q18=R 12" },
		{ 0, "", "", "" },
		{ 0, "INV_BannerPVP_01", "=q6=#pvprh5#", "=q5=#pvps2#" },
		{ 23257, "INV_Helmet_09", "=q3=Champion's Leather Helm", "=ds=#s1#, #a2# =q18=R 10" },
		{ 23258, "INV_Shoulder_14", "=q3=Champion's Leather Shoulders", "=ds=#s3#, #a2# =q18=R 10" },
		{ 22879, "INV_Chest_Leather_05", "=q3=Legionnaire's Leather Chestpiece", "=ds=#s5#, #a2# =q18=R 8" },
		{ 22864, "INV_Gauntlets_15", "=q3=Blood Guard's Leather Grips", "=ds=#s9#, #a2# =q18=R 7" },
		{ 22880, "INV_Pants_08", "=q3=Legionnaire's Leather Legguards", "=ds=#s11#, #a2# =q18=R 8" },
		{ 22856, "INV_Boots_05", "=q3=Blood Guard's Leather Walkers", "=ds=#s12#, #a2# =q18=R 7" },
	};
	PVPDruid = {
		{ 0, "INV_BannerPVP_02", "=q8=#pvpea1#", "=q7=#pvps1#" },
		{ 16451, "INV_Helmet_41", "=q4=Field Marshal's Dragonhide Helmet", "=ds=#s1#, #a2# =q7=R 13" },
		{ 16449, "INV_Shoulder_23", "=q4=Field Marshal's Dragonhide Spaulders", "=ds=#s3#, #a2# =q7=R 13" },
		{ 16452, "INV_Chest_Cloth_07", "=q4=Field Marshal's Dragonhide Breastplate", "=ds=#s5#, #a2# =q7=R 13" },
		{ 16448, "INV_Gauntlets_21", "=q4=Marshal's Dragonhide Gauntlets", "=ds=#s9#, #a2# =q7=R 12" },
		{ 16450, "INV_Pants_06", "=q4=Marshal's Dragonhide Legguards", "=ds=#s11#, #a2# =q7=R 12" },
		{ 16459, "INV_Boots_08", "=q4=Marshal's Dragonhide Boots", "=ds=#s12#, #a2# =q7=R 12" },
		{ 0, "", "", "" },
		{ 0, "INV_BannerPVP_02", "=q8=#pvpra1#", "=q7=#pvps2#" },
		{ 23308, "INV_Helmet_09", "=q3=Lieutenant Commander's Dragonhide Headguard", "=ds=#s1#, #a2# =q7=R 10" },
		{ 23309, "INV_Shoulder_07", "=q3=Lieutenant Commander's Dragonhide Shoulders", "=ds=#s3#, #a2# =q7=R 10" },
		{ 23294, "INV_Chest_Leather_07", "=q3=Knight-Captain's Dragonhide Chestpiece", "=ds=#s5#, #a2# =q7=R 8" },
		{ 23280, "INV_Gauntlets_25", "=q3=Knight-Lieutenant's Dragonhide Grips", "=ds=#s9#, #a2# =q7=R 7" },
		{ 23295, "INV_Pants_06", "=q3=Knight-Captain's Dragonhide Leggings", "=ds=#s11#, #a2# =q7=R 8" },
		{ 23281, "INV_Boots_08", "=q3=Knight-Lieutenant's Dragonhide Treads", "=ds=#s12#, #a2# =q7=R 7" },
		{ 0, "INV_BannerPVP_01", "=q6=#pvpeh1#", "=q5=#pvps1#" },
		{ 16550, "INV_Helmet_09", "=q4=Warlord's Dragonhide Helmet", "=ds=#s1#, #a2# =q18=R 13" },
		{ 16551, "INV_Shoulder_07", "=q4=Warlord's Dragonhide Epaulets", "=ds=#s3#, #a2# =q18=R 13" },
		{ 16549, "INV_Chest_Chain_16", "=q4=Warlord's Dragonhide Hauberk", "=ds=#s5#, #a2# =q18=R 13" },
		{ 16555, "INV_Gauntlets_25", "=q4=General's Dragonhide Gloves", "=ds=#s9#, #a2# =q18=R 12" },
		{ 16552, "INV_Pants_06", "=q4=General's Dragonhide Leggings", "=ds=#s11#, #a2# =q18=R 12" },
		{ 16554, "INV_Boots_08", "=q4=General's Dragonhide Boots", "=ds=#s12#, #a2# =q18=R 12" },
		{ 0, "", "", "" },
		{ 0, "INV_BannerPVP_01", "=q6=#pvprh1#", "=q5=#pvps2#" },
		{ 23253, "INV_Helmet_09", "=q3=Champion's Dragonhide Headguard", "=ds=#s1#, #a2# =q18=R 10" },
		{ 23254, "INV_Shoulder_07", "=q3=Champion's Dragonhide Shoulders", "=ds=#s3#, #a2# =q18=R 10" },
		{ 22877, "INV_Chest_Leather_07", "=q3=Legionnaire's Dragonhide Chestpiece", "=ds=#s5#, #a2# =q18=R 8" },
		{ 22863, "INV_Gauntlets_25", "=q3=Blood Guard's Dragonhide Grips", "=ds=#s9#, #a2# =q18=R 7" },
		{ 22878, "INV_Pants_06", "=q3=Legionnaire's Dragonhide Leggings", "=ds=#s11#, #a2# =q18=R 8" },
		{ 22852, "INV_Boots_08", "=q3=Blood Guard's Dragonhide Treads", "=ds=#s12#, #a2# =q18=R 7" },
	};
	PVPShaman = {
		{ 0, "", "", "" },
		{ 0, "", "", "" },
		...
		{ 16578, "INV_Helmet_09", "=q4=Warlord's Mail Helm", "=ds=#s1#, #a3# =q18=R 13" },
		{ 16580, "INV_Shoulder_29", "=q4=Warlord's Mail Spaulders", "=ds=#s3#, #a3# =q18=R 13" },
		{ 16577, "INV_Chest_Chain_11", "=q4=Warlord's Mail Armor", "=ds=#s5#, #a3# =q18=R 13" },
		{ 16574, "INV_Gauntlets_11", "=q4=General's Mail Gauntlets", "=ds=#s9#, #a3# =q18=R 12" },
		{ 16579, "INV_Pants_Mail_15", "=q4=General's Mail Leggings", "=ds=#s11#, #a3# =q18=R 12" },
		{ 16573, "INV_Boots_Plate_06", "=q4=General's Mail Boots", "=ds=#s12#, #a3# =q18=R 12" },
		{ 0, "", "", "" },
		{ 0, "INV_BannerPVP_01", "=q6=#pvprh6#", "=q5=#pvps2#" },
		{ 23259, "INV_Helmet_09", "=q3=Champion's Mail Headguard", "=ds=#s1#, #a3# =q18=R 10" },
		{ 23260, "INV_Shoulder_04", "=q3=Champion's Mail Pauldrons", "=ds=#s3#, #a3# =q18=R 10" },
		{ 22876, "INV_Chest_Chain_16", "=q3=Legionnaire's Mail Hauberk", "=ds=#s5#, #a3# =q18=R 8" },
		{ 22867, "INV_Gauntlets_11", "=q3=Blood Guard's Mail Vices", "=ds=#s9#, #a3# =q18=R 7" },
		{ 22887, "INV_Pants_09", "=q3=Legionnaire's Mail Legguards", "=ds=#s11#, #a3# =q18=R 8" },
		{ 22857,"INV_Boots_07","=q3=Blood Guard's Mail Greaves", "=ds=#s12#, #a3# =q18=R 7" },
	};
	PVPWarrior = {
		{ 0, "INV_BannerPVP_02", "=q8=#pvpea8#", "=q7=#pvps1#" },
		{ 16478, "INV_Helmet_05", "=q4=Field Marshal's Plate Helm", "=ds=#s1#, #a4# =q7=R 13" },
		{ 16480, "INV_Shoulder_20", "=q4=Field Marshal's Plate Shoulderguards", "=ds=#s3#, #a4# =q7=R 13" },
		{ 16477, "INV_Chest_Plate03", "=q4=Field Marshal's Plate Armor", "=ds=#s5#, #a4# =q7=R 13" },
		{ 16484, "INV_Gauntlets_29", "=q4=Marshal's Plate Gauntlets", "=ds=#s9#, #a4# =q7=R 12" },
		{ 16479, "INV_Pants_04", "=q4=Marshal's Plate Legguards", "=ds=#s11#, #a4# =q7=R 12" },
		{ 16483, "INV_Boots_Plate_09", "=q4=Marshal's Plate Boots", "=ds=#s12#, #a4# =q7=R 12" },
		{ 0, "", "", "" },
		{ 0, "INV_BannerPVP_02", "=q8=#pvpra8#", "=q7=#pvps2#" },
		{ 23314, "INV_Helmet_09", "=q3=Lieutenant Commander's Plate Helm", "=ds=#s1#, #a4# =q7=R 10" },
		{ 23315, "INV_Shoulder_11", "=q3=Lieutenant Commander's Plate Shoulders", "=ds=#s3#, #a4# =q7=R 10" },
		{ 23300, "INV_Chest_Plate16", "=q3=Knight-Captain's Plate Hauberk", "=ds=#s5#, #a4# =q7=R 8" },
		{ 23286, "INV_Gauntlets_26", "=q3=Knight-Lieutenant's Plate Gauntlets", "=ds=#s9#, #a4# =q7=R 7" },
		{ 23301, "INV_Pants_06", "=q3=Knight-Captain's Plate Leggings", "=ds=#s11#, #a4# =q7=R 8" },
		{ 23287, "INV_Boots_Plate_09", "=q3=Knight-Lieutenant's Plate Greaves", "=ds=#s12#, #a4# =q7=R 7" },
		{ 0, "INV_BannerPVP_01", "=q6=#pvpeh8#", "=q5=#pvps1#" },
		{ 16542, "INV_Helmet_09", "=q4=Warlord's Plate Headpiece", "=ds=#s1#, #a4# =q18=R 13" },
		{ 16544, "INV_Shoulder_11", "=q4=Warlord's Plate Shoulders", "=ds=#s3#, #a4# =q18=R 13" },
		{ 16541, "INV_Chest_Plate16", "=q4=Warlord's Plate Armor", "=ds=#s5#, #a4# =q18=R 13" },
		{ 16548, "INV_Gauntlets_10", "=q4=General's Plate Gauntlets", "=ds=#s9#, #a4# =q18=R 12" },
		{ 16543, "INV_Pants_04", "=q4=General's Plate Leggings", "=ds=#s11#, #a4# =q18=R 12" },
		{ 16545, "INV_Boots_Plate_04", "=q4=General's Plate Boots", "=ds=#s12#, #a4# =q18=R 12" },
		{ 0, "", "", "" },
		{ 0, "INV_BannerPVP_01", "=q6=#pvprh8#", "=q5=#pvps2#" },
		{ 23244, "INV_Helmet_09", "=q3=Champion's Plate Helm", "=ds=#s1#, #a4# =q18=R 10" },
		{ 23243, "INV_Shoulder_11", "=q3=Champion's Plate Shoulders", "=ds=#s3#, #a4# =q18=R 10" },
		{ 22872, "INV_Chest_Plate16", "=q3=Legionnaire's Plate Hauberk", "=ds=#s5#, #a4# =q18=R 8" },
		{ 22868, "INV_Gauntlets_26", "=q3=Blood Guard's Plate Gauntlets", "=ds=#s9#, #a4# =q18=R 7" },
		{ 22873, "INV_Pants_06", "=q3=Legionnaire's Plate Leggings", "=ds=#s11#, #a4# =q18=R 8" },
		{ 22858, "INV_Boots_Plate_09", "=q3=Blood Guard's Plate Greaves", "=ds=#s12#, #a4# =q18=R 7" },
	};
	PVPPaladin = {
		{ 0, "INV_BannerPVP_02", "=q8=#pvpea4#", "=q7=#pvps1#" },
		{ 16474, "INV_Helmet_05", "=q4=Field Marshal's Lamellar Faceguard", "=ds=#s1#, #a4# =q7=R 13" },
		{ 16476, "INV_Shoulder_20", "=q4=Field Marshal's Lamellar Pauldrons", "=ds=#s3#, #a4# =q7=R 13" },
		{ 16473, "INV_Chest_Plate03", "=q4=Field Marshal's Lamellar Chestplate", "=ds=#s5#, #a4# =q7=R 13" },
		{ 16471, "INV_Gauntlets_29", "=q4=Marshal's Lamellar Gloves", "=ds=#s9#, #a4# =q7=R 12" },
		{ 16475, "INV_Pants_04", "=q4=Marshal's Lamellar Legplates", "=ds=#s11#, #a4# =q7=R 12" },
		{ 16472, "INV_Boots_Plate_09", "=q4=Marshal's Lamellar Boots", "=ds=#s12#, #a4# =q7=R 12" },
		{ 0, "", "", "" },
		{ 0, "INV_BannerPVP_02", "=q8=#pvpra4#", "=q7=#pvps2#" },
		{ 23276, "INV_Helmet_05", "=q3=Lieutenant Commander's Lamellar Headguard", "=ds=#s1#, #a4# =q7=R 10" },
		{ 23277, "INV_Shoulder_28", "=q3=Lieutenant Commander's Lamellar Shoulders", "=ds=#s3#, #a4# =q7=R 10" },
		{ 23272, "INV_Chest_Plate03", "=q3=Knight-Captain's Lamellar Breastplate", "=ds=#s5#, #a4# =q7=R 8" },
		{ 23274, "INV_Gauntlets_29", "=q3=Knight-Lieutenant's Lamellar Gauntlets", "=ds=#s9#, #a4# =q7=R 7" },
		{ 23273, "INV_Pants_06", "=q3=Knight-Captain's Lamellar Leggings", "=ds=#s11#, #a4# =q7=R 8" },
		{ 23275, "INV_Boots_Plate_03", "=q3=Knight-Lieutenant's Lamellar Sabatons", "=ds=#s12#, #a4# =q7=R 7" },
	};
	PvPMountsPvP = {
		{ 0, "", "", "" },
		{ 0, "INV_BannerPVP_02", "=q8=#m7#", "=q7=R 11" },
		{ 0, "", "", "" },
		{ 19030, "Ability_Mount_MountainRam", "=q4=Stormpike Battle Charger", "=ds=#e7#" },
		{ 0, "", "", "" },
		...
		{ 0, "", "", "" },
		{ 0, "", "", "" },
		{ 0, "INV_BannerPVP_01", "=q6=#m6#", "=q18=R 11" },
		{ 0, "", "", "" },
		{ 19029, "INV_Misc_Horn_01", "=q4=Horn of the Frostwolf Howler", "=ds=#e7#" },
		{ 0, "", "", "" },
