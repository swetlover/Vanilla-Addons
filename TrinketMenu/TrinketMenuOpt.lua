...
{"ShowIcon","ON","小地图按钮","显示隐藏小地图按钮."},
{"SquareMinimap","OFF","方形地图","按钮按方形地图模式运行","ShowIcon"},
{"CooldownCount","OFF","冷却时间","显示冷却时间."},
{"TooltipFollow","OFF","鼠标提示","鼠标移到饰品上提示物品信息.","ShowTooltips"},
{"KeepOpen","OFF","打开饰品列表","总是显示饰品列表."},
{"KeepDocked","ON","列表粘附","保持列表粘附."},
{"Notify","OFF","可使用提示","Sends an overhead notification when a trinket's cooldown is complete."},
{"DisableToggle","OFF","禁用切换","Disables the minimap button's ability to toggle the trinket frame.","ShowIcon"},
{"NotifyChatAlso","OFF","在聊天窗口提示","Sends notifications through chat also."},
{"Locked","OFF","锁窗口","Prevents the windows from being moved, resized or rotated."},
{"ShowTooltips","ON","显示鼠标提示","Shows tooltips."},
{"NotifyThirty","ON","30秒提示","Sends an overhead notification when a trinket has 30 seconds left on cooldown."},
{"MenuOnShift","OFF","显示列表Shift","Check this to prevent the menu appearing unless Shift is held."},
{"TinyTooltips","OFF","迷你提示","Shrink trinket tooltips to only their name, charges and cooldown.","ShowTooltips"},
{"SetColumns","OFF","设置列表列数","Define how many trinkets before the menu will wrap to the next row.\n\nUncheck to let TrinketMenu choose how to wrap the menu."},
{"LargeCooldown","ON","冷却显示中心","字体变大在正中心.","CooldownCount"},
{"ShowHotKeys","ON","显示快捷键","Display the key bindings over the equipped trinkets."},
{"StopOnSwap","OFF","被动饰品停止队列","Swapping a passive trinket stops an auto queue.  Check this to also stop the auto queue when a clickable trinket is manually swapped in via TrinketMenu.  This will have the most use to those with frequent trinkets marked Priority."},
{"HideOnLoad","OFF","关闭加载配置文件","Check this to dismiss this window when you load a profile."}
}

-- table.insert(TrinketMenu.CheckOptInfo,)

TrinketMenu.TooltipInfo = {
{"TrinketMenu_LockButton","锁窗口","Prevents the windows from being moved, resized or rotated."},
{"TrinketMenu_Trinket0Check","上饰品自动队列","Check this to enable auto queue for this trinket slot.  You can also Alt+Click the trinket slot to toggle Auto Queue."},
{"TrinketMenu_Trinket1Check","下饰品自动队列","Check this to enable auto queue for this trinket slot.  You can also Alt+Click the trinket slot to toggle Auto Queue."},
...
{"TrinketMenu_Profiles","配置文件","Here you can load or save auto queue profiles."},
...
{"TrinketMenu_ProfilesDelete","删除配置文件","Remove this profile."},
...
{"TrinketMenu_ProfileName","配置文件名字","Enter a name to call the profile.  When saved, you can load this profile to either trinket slot."},
}
