...
function BigWigs:Test()
	...
	for name, module in self:IterateModules() do
		...
		if not status then
			count = count + 1
			BigWigs:Print("|cffff0000" .. name .. "|r 测试模块 |cffff0000失败:|r " .. retval)
		end
	end
