...
L:RegisterTranslations("zhCN", function() return {
	...
	engage_message = "萨菲隆来势汹汹! 15分钟后狂暴!",

	lifedrain_message = "吸取生命! 下一个可能 ~24秒!",
	lifedrain_warn1 = "吸取生命 5秒!",
	lifedrain_bar = "吸取生命",
	...
	deepbreath_incoming_message = "深呼吸施放大约 ~23秒!",
	deepbreath_incoming_soon_message = "深呼吸施放大约 ~5秒!",
