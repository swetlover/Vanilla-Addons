...
L:RegisterTranslations("zhCN", function() return {
	...
	vulnerability_direct_test = "^.+ 的 (.+) 克洛玛古斯造成 (%d+) 点 ([^%s]+) 伤害。", -- [Fashu's] [Firebolt] [hits] Battleguard Sartura for [44] [Fire] damage. ([14] resisted)
	vulnerability_dots_test = "^.+ 的 (.+) 使克洛玛古斯受到了 (%d+) 点 ([^%s]+) 伤害。",
