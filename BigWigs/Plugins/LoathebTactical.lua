...
L:RegisterTranslations("zhCN", function() return {
	...
	noconsumable_name = "不警告RAID使用消耗品 (A)",
	noconsumable_desc = "When checked does NOT warn raid to use consumables over raidwarn. Requires Assistance (A)",
	
	nospore_cmd = "spore",
	nospore_name = "不警报孢子 (A)",
	nospore_desc = "不会标记玩家获得孢子buff. 需要权限 (A)",
	
	doomtrigger = "受到了必然的厄运效果的影响。",
	
	shadowpot = "喝暗影防护药水!",
	bandage = "用你的绷带!",
	healthstone = "生命石或鞭根块茎!",
	shadowpotandbandage = "喝暗影保护药水，用绷带!",
	noconsumable = "这次不用药水!",
	
	groupspore = "孢子队伍 %s",
	
	enablewarning = "|cffff8888BigWigs 洛欧塞布战术模块|r - 发布建议的消耗品使用和标记组孢子与RAID图标开始第2组开始. 这两个选项都必须手动激活.",
	
	["Greater Shadow Protection Potion"] = "强效暗影防护药水",
	["Heavy Runecloth Bandage"] = "厚符文布绷带",
	["Greater Healthstone"] = "强效治疗石",
    ["Could not find %s in your inventory."] = "在你的背包里找不到%s",
} end )
