...
L:RegisterTranslations("zhCN", function() return {
    ["Onyxias Cloak"] = "奥妮克希亚披风", -- plugin name
    --["onyxiaCloak"] = true, -- console command
    ["Equips Onyxias Cloak when you enter Nefarian's Lair and switches back when you leave the area again."] = "当你进入奈法房间时和离开再返回时,自动装备奥妮克希亚披风.",
