...
function BigWigsScorchTimer:PlayerDamageEvents(msg)
	...
	self:StartBar(victim.. " - 痛苦诅咒", 30, "Interface\\Icons\\Spell_Fire_Soulburn")
	return
	end
...
function BigWigsScorchTimer:Test()
	self:StartBar("怪物 1", timer.scorch, "Interface\\Icons\\Spell_Fire_Soulburn")
	self:StartBar("怪物 2", timer.scorch/2, "Interface\\Icons\\Spell_Fire_Soulburn")
end
