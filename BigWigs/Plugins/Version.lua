...
L:RegisterTranslations("zhCN", function() return {
	...
	["<BigWigs> Everyone has the current version of BigWigs Classic-WoW. I'm proud of you!"] = "<BigWigs> 每个人都有当前版本的 BigWigs Classic-WoW.",
	...
	["<BigWigs> Please download the newest version of BigWigs Classic-WoW from https://github.com/xorann/BigWigs/releases"] = "<BigWig> 请下载最新版本 http://www.60addons.com",
