...
L:RegisterTranslations("zhCN", function() return {
	...
	["Doused Runes"] = "熄灭符文",
	["Disabled"] = "禁用",
    ["Options for the doused runes Display."] = "熄灭符文显示选项",
    ["Show frame"] = "显示框架",
    ["Show the doused runes frame."] = "显示符文熄灭框架.",
    ["Show on douse"] = "显示熄灭",
    ["Show the display after a rune is doused."] = "一个符文熄灭后显示.",
    ["Show on Boss Kill"] = "显示 Boss 击杀",
	["Show the display after a boss has been killed."] = "在boss被杀后展示显示器.",
    ["Reset position"] = "重置位置",
