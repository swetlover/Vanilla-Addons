...
L:RegisterTranslations("zhCN", function() return {
	["Enrage"] = "狂怒", -- module name
	["enrage"] = true, -- console command
	
	 -- console options
	["Options for the enrage plugin."] = "狂怒插件的设置",
	["Show anchor"] = "显示锚点",
	["Show the bar anchor frame."] = "显示锚点条",
	["Reset position"] = "重置位置",
	["Reset the anchor position, moving it to the original position."] = "重置锚点位置，移动到原来的位置",
	["Scale"] = "大小",
	["Set the frame scale."] = "设置框架大小",
	["Texture"] = "纹理",
	["Set the texture for the timerbars."] = "设置计时器纹理",
    ["Health"] = "血量",
