...
function Banana_Layout2()
	...
	RaidTargetFrame4Button:SetPoint("LEFT", RaidTargetFrame3Button, "RIGHT",4,0);
	RaidTargetFrame5Button:ClearAllPoints();
	RaidTargetFrame5Button:SetPoint("TOP", RaidTargetFrame1Button, "BOTTOM",0,-12);
	RaidTargetFrame6Button:ClearAllPoints();
	RaidTargetFrame6Button:SetPoint("LEFT", RaidTargetFrame5Button, "RIGHT",4,0);
	RaidTargetFrame7Button:ClearAllPoints();
	RaidTargetFrame7Button:SetPoint("LEFT", RaidTargetFrame6Button, "RIGHT",4,0);
...
function Banana_Layout3()
	...
	RaidTargetFrame2Button:SetPoint("LEFT", RaidTargetFrame1Button, "RIGHT",4,0);
	RaidTargetFrame3Button:ClearAllPoints();
	RaidTargetFrame3Button:SetPoint("TOP", RaidTargetFrame1Button, "BOTTOM",0,-12);
	RaidTargetFrame4Button:ClearAllPoints();
	RaidTargetFrame4Button:SetPoint("LEFT", RaidTargetFrame3Button, "RIGHT",4,0);
	RaidTargetFrame5Button:ClearAllPoints();
	RaidTargetFrame5Button:SetPoint("TOP", RaidTargetFrame3Button, "BOTTOM",0,-12);
	RaidTargetFrame6Button:ClearAllPoints();
	RaidTargetFrame6Button:SetPoint("LEFT", RaidTargetFrame5Button, "RIGHT",4,0);
	RaidTargetFrame7Button:ClearAllPoints();
	RaidTargetFrame7Button:SetPoint("TOP", RaidTargetFrame5Button, "BOTTOM",0,-12);
	RaidTargetFrame8Button:ClearAllPoints();
	RaidTargetFrame8Button:SetPoint("LEFT", RaidTargetFrame7Button, "RIGHT",4,0);
	RaidTargetFrame9Button:ClearAllPoints();
...
function Banana_Layout4()
	...
	RaidTargetFrame1Button:ClearAllPoints();
	RaidTargetFrame2Button:ClearAllPoints();
	RaidTargetFrame2Button:SetPoint("TOP", RaidTargetFrame1Button, "BOTTOM",0,-12);
	RaidTargetFrame3Button:ClearAllPoints();
	RaidTargetFrame3Button:SetPoint("TOP", RaidTargetFrame2Button, "BOTTOM",0,-12);
	RaidTargetFrame4Button:ClearAllPoints();
	RaidTargetFrame4Button:SetPoint("TOP", RaidTargetFrame3Button, "BOTTOM",0,-12);
	RaidTargetFrame5Button:ClearAllPoints();
	RaidTargetFrame5Button:SetPoint("TOP", RaidTargetFrame4Button, "BOTTOM",0,-12);
	RaidTargetFrame6Button:ClearAllPoints();
	RaidTargetFrame6Button:SetPoint("TOP", RaidTargetFrame5Button, "BOTTOM",0,-12);
	RaidTargetFrame7Button:ClearAllPoints();
	RaidTargetFrame7Button:SetPoint("TOP", RaidTargetFrame6Button, "BOTTOM",0,-12);
	RaidTargetFrame8Button:ClearAllPoints();
	RaidTargetFrame8Button:SetPoint("TOP", RaidTargetFrame7Button, "BOTTOM",0,-12);
	RaidTargetFrame9Button:ClearAllPoints();
