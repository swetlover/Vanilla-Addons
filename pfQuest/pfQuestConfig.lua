...
pfQuestConfig.title:SetText("|cff33ffccpf|rQuest 设置")
...
pfQuestConfig:SetScript("OnEvent", function()
  if arg1 == "pfQuest" then
    CreateConfigEntry("allquestgivers",      "显示所有任务给予者标记",      "checkbox")
    CreateConfigEntry("currentquestgivers",  "显示当前任务给予者标记",  "checkbox")
    CreateConfigEntry("showlowlevel",        "显示低等级任务给予者标记", "checkbox")
    CreateConfigEntry("minimapnodes",        "显示小地图标记",             "checkbox")
    CreateConfigEntry("questlogbuttons",     "显示任务日志按钮",          "checkbox")
    CreateConfigEntry("worldmapmenu",        "显示世界地图菜单",             "checkbox")
    CreateConfigEntry("worldmaptransp",      "大地图标记透明度",     "text")
    CreateConfigEntry("minimaptransp",       "小地图标记透明度",      "text")
  end
end)
...
pfQuestConfig.clean.text:SetText("退出 & 重载")
