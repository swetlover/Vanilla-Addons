local CheckBoxTables = {
	...
	["组队自动接受"] = {
		...
		[4] = { "LazyPigCheckbox33", "不自动接受邀请当在战场或者队列中时" }
	},
	...
	["其他功能"] = {
		...
		[9] = { "LazyPigCheckbox98", "闲谈自动处理", "跳过飞行管理员和酒店老板的闲谈" },
		[10] = { "LazyPigCheckbox99", "自动保存", "自动使用.save 什么时候需要？" },
...
function LazyPig_CreateOptionsFrame()
	...
	fs_title:SetText("_懒猪 设置 By 60addons")
