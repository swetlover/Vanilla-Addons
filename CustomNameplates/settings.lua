...
local genSettings = {
  ...
  ["hbwidth"]=125,               -- width of nameplates
  ["hbheight"]=8,               -- height of nameplates
...
local debufficon = {
  ...
  ["yoffs"]=15, -- -13,         -- vertical offset of the first row of debuffs
...
local nametext = {
  ...
  ["anchorpoint"]="TOP",
  ["xoffs"]=0,                  -- horizontal offset (+ moves it right, - left)
  ["yoffs"]=0                  -- vertical offset (+ moves it up, - moves it down) 
}
local leveltext = {
  ["hide"]=false,
  ["size"]=11,
  ...
  ["xoffs"]=0,                  -- horizontal offset (+ moves it right, - left)
  ["yoffs"]=10                   -- vertical offset (+ moves it up, - moves it down)
}
