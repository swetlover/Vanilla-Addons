  ...
  for _, namePlate in ipairs(frames) do
	...
	--[[		if (ADDON.namePlateCache[namePlate] == nil) then
	  ...
	  if namePlate.cast == nil then
		...
		namePlate.cast:SetHeight(10)
		namePlate.cast:SetStatusBarTexture([[Interface\AddOns\CustomNameplates\textures\striped]])
		...
		namePlate.cast:SetPoint('LEFT', namePlate, 24, 0)
		namePlate.cast:SetPoint('RIGHT', namePlate, -12, 0)
		namePlate.cast:SetPoint('TOP', HealthBar, 'BOTTOM', 0, -2)
		...
		namePlate.cast.icon:SetWidth(10) namePlate.cast.icon:SetHeight(10)
