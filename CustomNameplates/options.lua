...
local function Options()
  ...
  optionsFrame.title:SetText("带Debuff时间版本Q猫美化版by60addons")
  ...
  CustomNameplatescb3Text:SetText("显示敌对")
  ...
  CustomNameplatescb1Text:SetText("显示友方")
  ...
  CustomNameplatescb2Text:SetText("只在战斗中显示")
  ...
  CustomNameplatescb4Text:SetText("宠物")
  ...
  CustomNameplatescb5Text:SetText("通过点击")
  ...
  CustomNameplatescb6Text:SetText("占位符6")
  ...
  CustomNameplatescb7Text:SetText("占位符7")
  ...
  CustomNameplatescb7Text:SetText("占位符11")
...
ADDON.leveltext = _G.CustomNameplatesSettings and _G.CustomNameplatesSettings.leveltext
  ...
  optionsFrame.preview.help:SetText("姓名板预览")
  ...
  optionsFrame.UpdateSlider = function()
    CustomNameplatesslider1Text:SetText(string.format("刷新度: %d FPS",math.ceil(1/CustomNameplatesDBPC.genSettings.refreshRate) or 60))
