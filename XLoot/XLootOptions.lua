		...
		args = {
			...
			advanced = {
				...
				args = {
					...
					forcecompat = {
						type = "toggle",
						name = L["2.0 compatability"],
						desc = L["If you're getting errors with table.setn, enable this"],
						get = function() return self.compat end,
						set = function(v) self.db.profile.forcecompat = v; self.compat = v end,
						order = 2
					},
					adspacer = {
						type = "header",
